...
//    String messageUrl = "GET https://www.googleapis.com/gmail/v1/users/smallbabba%40gmail.com/messages/1531a7973efca9ac?key={552298778425-tgldggth765ifsfitrk87k71m9q54c5t.apps.googleusercontent.com}";
...
//        EmailListAdapter emailListAdapter = new EmailListAdapter(MainActivity.this, mInboxArrayList);
//        mEmailsListView.setAdapter(emailListAdapter);
        ...
        MailAsyncTask mailAsynTask = new MailAsyncTask(mCredential);
        mailAsynTask.execute();
...
//                    intent.putExtra("key", selectedPlanet);
...
//            Log.d("Sincerely is it?", "stopping here or not");
